...
const {
  ...
  getMark,
  getDegree_B,
} = require("./../controllers/school.data.controller");
const {
  countVisits,
  addVisits,
  countLogin,
  addLogin,
  loginData,
} = require("../controllers/visit.count.controller");
const { LoginData } = require("../models/school.model");

// Assessment Data
const {
  getAssessment,
} = require("./../controllers/assessment.data.controller");
// Excel Files
...
const {
  ...
  getTopicTitles,
  getCourseTitles,
} = require("../controllers/courses.contoller");
const {
  updateTopic,
  deleteTopic,
  createTopic,
} = require("../controllers/topics.curd.contoller");
const {
  getCoursesByGrade,
  createCourse,
  updateCourse,
  deleteCourse,
  updateCourseImg,
} = require("../controllers/course.curd.controller");
const {
  getSubpartByGrade,
  createSubpart,
  updateSubpart,
  deleteSubpart,
  updateSubpartImg,
} = require("./../controllers/subpart.curd.controller");
const {
  getVocabularyByGrade,
  deleteVocabulary,
  createVocabulary,
  updateVocabulary,
} = require("./../controllers/vocabulary.curd.controller");
const {
  getReviewsByGrade,
  deleteReview,
  createReview,
  updateReview,
  updateReviewImg,
} = require("./../controllers/review.curd.controller");
const {
  getQuizzesByGrade,
  deleteQuiz,
  updateQuiz,
  createQuiz,
  getNewQuzeId,
} = require("./../controllers/quizzs.curd.controller");
const {
  getQuestionsByQuiz,
  deleteQuestion,
  createQuestion,
  updateQuestion,
  getNewQuestionId,
} = require("./../controllers/questions.curd.contoroller");
const {
  getAnswersByGrade,
  deleteAnswer,
  createAnswer,
  updateAnswer,
} = require("./../controllers/answer.curd.controller");
// Lesson Visits
const {
  addLessonVisit,
  getLessonVisits,
  resetLessonVisits,
} = require("../controllers/lesson.visit.controller");
...
let routes = (app) => {
  ...
  router.get(
    "/api/lesson-visits/:studentId/:subjectId/:termId",
    testisStdOrAdin,
    getLessonVisits,
  ); // استرجاع زيارات الطالب
  ...
  router.post(
    ...
    testisTechOrAdin,
    controller.uploadCourseImage,
  );
  router.post(
    "/api/uploadsubpartimage",
    testisTechOrAdin,
    controller.uploadSubpartImage,
  );
  router.post(
  ...
  router.delete(
    "/api/courseimage/:name",
    testisTechOrAdin,
    imgController.deleteCourseImage,
  );
  router.delete(
    "/api/subpartimage/:name",
    testisTechOrAdin,
    imgController.deleteSubpartImage,
  );
  router.delete(
    "/api/reviewimage/:name",
    testisTechOrAdin,
    imgController.deleteReviewImage,
  );
  router.delete(
    "/api/questionimage/:name",
    testisTechOrAdin,
    imgController.deleteQuestionImage,
  );
  ...
  // Test School Data
  router.get(
    "/api/degree/:stdId/:testKindId/:yearId?",
    testisStdOrAdin,
    getDegree,
  );
  router.get(
    "/api/degree_b/:stdId/:testKindId/:yearId?",
    testisStdOrAdin,
    getDegree_B,
  );
  router.get("/api/mark/:stdId/:testKindId/:yearId?", testisStdOrAdin, getMark);
  router.get(
    "/api/getListInfoById/:secid/:classid/",
    testisStdOrAdin,
    listImages.getListInfoById,
  );

  // Courses
  router.get(
    "/api/alltopics/:gredId/:subjectId/",
    testisTechOrAdin,
    getAllTopics,
  );
  router.get(
    "/api/topics/:gredId/:termId/:subjectId",
    testisStdOrAdin,
    getTopics,
  );
  router.get(
    "/api/course/:courseId/:gredId/:termId/:subjectId",
    testisStdOrAdin,
    getCourse,
  );
  router.get(
    "/api/quiz/:quizId/:courseId/:gredId/:termId/:subjectId",
    testisStdOrAdin,
    getQuze,
  );
  ...
  // Curd Topic
  router.get(
    "/api/topicstitle/:gredId/:subjectId",
    testisStdOrAdin,
    getTopicTitles,
  );
  router.post("/api/topic/", testisTechOrAdin, createTopic);
  router.put(
    "/api/topic/:topicId/:gredId/:subjectId/:termId",
    testisTechOrAdin,
    updateTopic,
  );
  router.delete(
  ...
  //Curd Courses
  router.get(
    "/api/coursestitle/:gredId/:subjectId",
    testisStdOrAdin,
    getCourseTitles,
  );
  router.get(
    "/api/getcoursebygrade/:gredId/:subjectId",
    testisStdOrAdin,
    getCoursesByGrade,
  );
  router.post("/api/course/", testisTechOrAdin, createCourse);
  router.put(
    "/api/course/:courseId/:gredId/:subjectId/:termId",
    testisTechOrAdin,
    updateCourse,
  );
  router.put("/api/courseimg/:courseImg/", testisTechOrAdin, updateCourseImg);
  router.delete(
    "/api/course/:topicId/:courseId/:gredId/:subjectId/:termId",
    testisTechOrAdin,
    deleteCourse,
  );
  ...
  //Curd Subparts
  router.get(
    "/api/getsubpartbygrade/:gredId/:subjectId",
    testisStdOrAdin,
    getSubpartByGrade,
  );
  ...
  // Curd Vocabulary
  router.get(
    "/api/getvocabularybygrade/:gredId/:subjectId",
    testisStdOrAdin,
    getVocabularyByGrade,
  );
  router.delete(
  ...
  // Curd Reviews
  router.get(
    "/api/getreviewbygrade/:gredId/:subjectId",
    testisStdOrAdin,
    getReviewsByGrade,
  );
  ...
  // Curd Quizzes
  router.get(
    "/api/getquizbygrade/:gredId/:subjectId",
    testisStdOrAdin,
    getQuizzesByGrade,
  );
  router.delete(
    "/api/quiz/:quizId/:courseId/:gradeId/:subjectId/:termId",
    testisTechOrAdin,
    deleteQuiz,
  );
  router.put(
  ...
  router.get(
    "/api/getquizid/:couresId/:gredId/:subjectId/:termId/",
    testisTechOrAdin,
    getNewQuzeId,
  );
  ...
  // Curd Questions
  router.get(
    "/api/getquestionsbyquiz/:quizId/:courseId/:gredId/:subjectId/:termId/",
    testisStdOrAdin,
    getQuestionsByQuiz,
  );
  router.delete(
    "/api/question/:questionId/:courseId/:quizId/:gradeId/:subjectId/:termId/",
    testisTechOrAdin,
    deleteQuestion,
  );
  ...
  router.get(
    "/api/questionid/:courseId/:quizId/:gradeId/:subjectId/:termId/",
    testisTechOrAdin,
    getNewQuestionId,
  );
  ...
  //Curd Answers
  router.get(
    "/api/answer/:questionId/:courseId/:quizId/:gradeId/:subjectId/:termId/",
    testisTechOrAdin,
    getAnswersByGrade,
  );
  ...
  // Curd Assessment
  router.get(
    "/api/assessment/:student_Id/:term_id/",
    testisStdOrAdin,
    getAssessment,
  );
  ...
  router.post(
    ...
    excelController.upload_student,
  );
  router.post(
    "/api/upload/degree",
    testAdmin,
    uploadExcel.single("file"),
    excelController.upload_degree,
  );
  router.post(
    "/api/upload/mark",
    testAdmin,
    uploadExcel.single("file"),
    excelController.upload_mark,
  );
  router.post(
    "/api/upload/phrase",
    testAdmin,
    uploadExcel.single("file"),
    excelController.upload_phrase,
  );

  //Upload Assessment
  router.post(
    "/api/upload/asesarabic",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesArabic,
  );
  router.post(
    "/api/upload/asesmath",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesMath,
  );
  router.post(
    "/api/upload/asesscince",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesScince,
  );
  router.post(
    "/api/upload/asessocial",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesSocial,
  );
  router.post(
    "/api/upload/aseenglish",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesEnglish,
  );
  router.post(
    "/api/upload/asesdain",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesDain,
  );
  router.post(
    "/api/upload/asesmaharat",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesMaharat,
  );
  router.post(
    "/api/upload/asestocnolegy",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_asesMTocnolegy,
  );
  router.post(
    "/api/upload/asesgiab",
    testAdmin,
    uploadExcel.single("file"),
    assessementController.upload_giab,
  );
  ...
  router.put(
    "/api/update_quiz_history/:id",
    testisStdOrAdin,
    updateQuizHistory,
  );
  router.put(
    "/api/finish_quiz_history/:id",
    testisStdOrAdin,
    finishQuizHistory,
  );
  router.get(
    "/api/last_history/:stdCode/:termId/:subjectId",
    testisStdOrAdin,
    getLastQuizHistory,
  );
  router.get(
    "/api/finished_quizzes/:stdCode/:courseId/:termId/:subjectId",
    testisStdOrAdin,
    getFinishedQuizzesCount,
  );
  router.get(
    "/api/student_progress/:stdCode/:gradeId/:termId/:subjectId",
    testisStdOrAdin,
    getStudentSubjectProgress,
  );
